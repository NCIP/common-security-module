...
ALTER TABLE CSM_MAPPING ADD CONSTRAINT PK_MAPPING PRIMARY KEY (MAPPING_ID);
ALTER TABLE CSM_MAPPING ADD CONSTRAINT FK_MAPPING_APPLICATION  FOREIGN KEY (APPLICATION_ID) REFERENCES CSM_APPLICATION (APPLICATION_ID) ON DELETE CASCADE;
ALTER TABLE CSM_MAPPING ADD CONSTRAINT UQ_MP_OBJ_NAME_ATTRNAME_APP_ID UNIQUE (OBJECT_NAME,ATTRIBUTE_NAME,APPLICATION_ID);
