...
public class CGMMTest {
	...
	private static void testGetCSMUser() {
		...
		try {
			isValid = cah.isUserMigrated("cgmmtmpuser2");
			//isValid = cah.isUserMigrated("/O=caBIG/OU=caGrid/OU=Training/OU=Dorian/CN=cgmmtmpuser2");
		...
		else System.out.println("CSMAuthHelper: Could not get  User .");
