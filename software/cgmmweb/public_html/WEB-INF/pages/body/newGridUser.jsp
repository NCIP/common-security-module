...
<%@ page import="gov.nih.nci.security.migrate.constants.CGMMConstants"%>
<%@ page import="gov.nih.nci.security.migrate.webapp.viewobjects.*"%>
<%@ page import="gov.nih.nci.security.migrate.webapp.form.NewGridUserForm"%>
	...
	<td valign="top" class="contentPage">
		&nbsp;<table summary="" cellpadding="3" cellspacing="0" border="0"
			...
			<html:form styleId="newGridUserForm" action="/NewGridUser">
				...
				<bean:define name="<%=CGMMConstants.CURRENT_FORM%>" id="newGridUserForm" type="NewGridUserForm"  />
				...
				<tr>
					...
					<td class=formField>
						<INPUT class=formField id=firstName size=40 name=firstName value="<%=newGridUserForm.getFirstName()%>"> *
					</td>
				</tr>
				<tr>
					...
					<td class=formField>
						<INPUT class=formField id=lastName size=40 name=lastName value="<%=newGridUserForm.getLastName()%>"> *
					</td>
				</tr>
				<tr>
					<td class=formLabel width="30%">
					...
					<td class=formField>
						<INPUT class=formField id=userName size=40 name=userName value="<%=newGridUserForm.getUserName()%>"> *
					</td>
				</tr>
				<tr>
					<td class=formLabel width="30%">
				...
				<tr>
					...
					<td class=formField>
						<INPUT class=formField id=email size=40 name=email value="<%=newGridUserForm.getEmail()%>"> *
					</td>
				</tr>
				<tr>
					<td class=formLabel width="30%">
					...
					<td class=formField>
						<INPUT class=formField id=phone size=12 name=phone value="<%=newGridUserForm.getPhone()%>"> *
					</td>
				</tr>
				<tr>
					<td class=formLabel width="30%">
					...
					<td class=formField>
						<INPUT class=formField id=organization size=40 name=organization value="<%=newGridUserForm.getOrganization()%>"> *
					</td>
				</tr>
				<tr>
					<td class=formLabel width="30%">
				...
				<bean:define name="<%=CGMMConstants.USA_STATES_MAP%>" id="statesMap" />
				<tr>
					<td class=formLabel><LABEL for=field3><bean:message key="label.new_user_state" /></LABEL></td>
					<td class=formField>
						<html:select property="state">
							<html:options collection="statesMap" property="value" labelProperty="key"/> 
						</html:select> *
					</td>					
				</tr>
				<tr>
				...
				<bean:define name="<%=CGMMConstants.COUNTRY_MAP%>" id="countryMap" />
				<tr>

						<td class=formLabel><LABEL for=field3><bean:message key="label.new_user_country" /></LABEL></td>
						<td class=formField>
							<html:select property="country">
								<html:options collection="countryMap" property="value" labelProperty="key"/> 
							</html:select> *
						</td>					
				</tr>
				<tr>
