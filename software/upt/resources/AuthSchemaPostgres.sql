...
DROP FUNCTION SET_CSM_PG_PE_PG_PE_ID() CASCADE;

DROP FUNCTION SET_CSM_PG_PE_UPDATE_DATE() CASCADE;

DROP FUNCTION SET_CSM_ROLE_PRIV_ROLE_PRIVILE() CASCADE;

DROP FUNCTION SET_CSM_ROLE_PRIV_UPDATE_DATE() CASCADE;

DROP FUNCTION SET_CSM_USER_GROU_USER_GROUP_I() CASCADE;

DROP FUNCTION SET_CSM_USER_PE_USER_PROTECTIO() CASCADE;

DROP FUNCTION SET_CSM_USER_PE_UPDATE_DATE() CASCADE;
