...
--
-- UnComment following block to drop existing database schema objects
--
...
DROP SEQUENCE IF EXISTS CSM_PASSWORD_HISTORY_SEQ;



CREATE SEQUENCE CSM_APPLICATI_APPLICATION__SEQ START 3
;
...
CREATE SEQUENCE CSM_PRIVILEGE_PRIVILEGE_ID_SEQ START 11
;
...
CREATE SEQUENCE CSM_PROTECTIO_PROTECTION_E_SEQ START 3
;
...
CREATE SEQUENCE CSM_USER_USER_ID_SEQ START 2
;
...
CREATE TABLE CSM_PASSWORD_HISTORY (
	ID int8 default nextval('CSM_PASSWORD_HISTORY_SEQ'),
