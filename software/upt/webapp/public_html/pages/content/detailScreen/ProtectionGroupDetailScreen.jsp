							...
							<table cellpadding="4" cellspacing="0" border="0">
								<tr>
									...
									<logic:notEqual name="<%=DisplayConstants.CURRENT_FORM%>" property="primaryId" value="<%=DisplayConstants.BLANK%>">
										...
										<logic:present name='<%=Constants.CSM_DELETE_PRIVILEGE +"_"+Constants.UPT_PROTECTION_GROUP_OPERATION%>'>
											<td><button class="actionButton" onclick="setAndSubmit('delete');">Delete</button></td>
										</logic:present>
										<logic:notPresent name='<%=Constants.CSM_DELETE_PRIVILEGE +"_"+Constants.UPT_PROTECTION_GROUP_OPERATION%>'>
