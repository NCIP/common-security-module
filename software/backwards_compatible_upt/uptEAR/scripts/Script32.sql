...
﻿# Replace the csmauthschema_dev_bkwrdscmptble_3_2 with proper database name that is to be created.

CREATE DATABASE csm_dev_bkwrdscmptbl_3_2;
...
values ("csmupt32","CSM UPT Super Admin Application",0,0,sysdate());
...
insert into csm_user (LOGIN_NAME,FIRST_NAME,LAST_NAME,PASSWORD,UPDATE_DATE)
values ("admin","admin_first_name","admin_last_name","zJPWCwDeSgG8j2uyHEABIQ==",sysdate());
...
values("csmupt32","CSM UPT Super Admin Application Protection Element","csmupt32",1,sysdate());
...
"jdbc:mysql://localhost:3306/csm_dev_bkwrdscmptbl_3_2",
"root",
"H/2qIBdj9TQ=",
...
insert into csm_protection_element(PROTECTION_ELEMENT_NAME,PROTECTION_ELEMENT_DESCRIPTION,OBJECT_ID,APPLICATION_ID,UPDATE_DATE)
values("sample32","sample32 Admin Application Protection Element","sample32",1,sysdate());
