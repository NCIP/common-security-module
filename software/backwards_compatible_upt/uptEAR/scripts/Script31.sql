...
﻿CREATE DATABASE csm_dev_bkwrdscmptbl_3_1;
...
DROP TABLE IF EXISTS CSM_GROUPS
;
...
ADD CONSTRAINT UQ_PE_PE_NAME_ATT_APP_ID UNIQUE (OBJECT_ID, ATTRIBUTE, APPLICATION_ID)
;
CREATE INDEX idx_APPLICATION_ID ON CSM_PROTECTION_GROUP(APPLICATION_ID)
;
ALTER TABLE CSM_PROTECTION_GROUP
ADD CONSTRAINT UQ_PG_PROTECTION_GROUP_NAME UNIQUE (APPLICATION_ID, PROTECTION_GROUP_NAME)
;
CREATE INDEX idx_PARENT_PG_ID ON CSM_PROTECTION_GROUP(PARENT_PROTECTION_GROUP_ID)
;
...
ALTER TABLE CSM_GROUP ADD CONSTRAINT FK_GROUP_APPLICATION
...
ALTER TABLE CSM_PROTECTION_GROUP ADD CONSTRAINT FK_PROTECTION_GROUP_PG
...
values ("csmupt31","CSM UPT Super Admin Application",0,0,sysdate());

insert into csm_user (LOGIN_NAME,FIRST_NAME,LAST_NAME,PASSWORD,UPDATE_DATE)
values ("superadmin","super_admin_first_name","super_admin_last_name","changeme",sysdate());

insert into csm_user (LOGIN_NAME,FIRST_NAME,LAST_NAME,PASSWORD,UPDATE_DATE)
values ("admin","admin_first_name","admin_last_name","changeme",sysdate());
...
values("csmupt31","CSM UPT Super Admin Application Protection Element","csmupt31",1,sysdate());
...
INSERT INTO csm_application(APPLICATION_NAME,APPLICATION_DESCRIPTION,DECLARATIVE_FLAG,ACTIVE_FLAG,UPDATE_DATE)
VALUES ("sample31","Application Description",0,0,sysdate());



insert into csm_protection_element(PROTECTION_ELEMENT_NAME,PROTECTION_ELEMENT_DESCRIPTION,OBJECT_ID,APPLICATION_ID,UPDATE_DATE)
values("sample31","sample31 Admin Application Protection Element","sample31",1,sysdate());
