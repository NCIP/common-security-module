...
copy %TEMP_HOME_41%\webapp\public_html\WEB-INF\lib\acegi-security-1.0.3.jar webapp\public_html\WEB-INF\lib
copy %TEMP_HOME_41%\webapp\public_html\WEB-INF\lib\antlr-2.7.6.jar webapp\public_html\WEB-INF\lib
copy %TEMP_HOME_41%\webapp\public_html\WEB-INF\lib\asm-1.5.3.jar webapp\public_html\WEB-INF\lib
...
copy %TEMP_HOME_41%\webapp\public_html\WEB-INF\lib\ejb3-persistence-1.0.1.jar webapp\public_html\WEB-INF\lib
copy %TEMP_HOME_41%\webapp\public_html\WEB-INF\lib\hibernate-3.2.0.ga.jar webapp\public_html\WEB-INF\lib
copy %TEMP_HOME_41%\webapp\public_html\WEB-INF\lib\hibernate-annotations-1.0.jar webapp\public_html\WEB-INF\lib
copy %TEMP_HOME_41%\webapp\public_html\WEB-INF\lib\jdom-1.1.jar webapp\public_html\WEB-INF\lib
copy %TEMP_HOME_41%\webapp\public_html\WEB-INF\lib\jta-1.0.1B.jar webapp\public_html\WEB-INF\lib
copy %TEMP_HOME_41%\webapp\public_html\WEB-INF\lib\log4j-1.2.9.jar webapp\public_html\WEB-INF\lib
copy %TEMP_HOME_41%\webapp\public_html\WEB-INF\lib\mysql-connector-java-3.1.11.jar webapp\public_html\WEB-INF\lib
copy %TEMP_HOME_41%\webapp\public_html\WEB-INF\lib\servlet-2.3.1.jar webapp\public_html\WEB-INF\lib
copy %TEMP_HOME_41%\webapp\public_html\WEB-INF\lib\spring-1.2.8.jar webapp\public_html\WEB-INF\lib
copy %TEMP_HOME_41%\webapp\public_html\WEB-INF\lib\struts-1.1.jar webapp\public_html\WEB-INF\lib
mkdir webapp\src
copy %TEMP_HOME_41%\webapp\src\ApplicationSecurityConfig.xsd webapp\src
copy %TEMP_HOME_41%\webapp\src\csmupt41.csm.new.hibernate.cfg.xml webapp\src
...
copy %TEMP_HOME_41%\webapp\src\upt-beans.xml webapp\src
