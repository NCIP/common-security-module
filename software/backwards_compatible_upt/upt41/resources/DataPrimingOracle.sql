...
-- authorization schema, these enteries are not used and hence they can be left as it is.
--
...
values (1, 'csmupt41','UPT Super Admin Application',0,0,sysdate)
/
...
values(1, 'csmupt41','UPT Super Admin Application','csmupt41',1,sysdate)
/
