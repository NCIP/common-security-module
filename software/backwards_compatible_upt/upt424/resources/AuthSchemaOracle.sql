...
ALTER TABLE CSM_MAPPING ADD CONSTRAINT PK_CSM_MAPPING 
PRIMARY KEY (MAPPING_ID) 
;

ALTER TABLE CSM_MAPPING
ADD CONSTRAINT UQ_CSM_MAPPING UNIQUE (OBJECT_NAME,ATTRIBUTE_NAME,APPLICATION_ID)
;

ALTER TABLE CSM_MAPPING ADD CONSTRAINT FK_CSM_MAPPING 
