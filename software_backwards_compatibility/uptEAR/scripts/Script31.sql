...
ADD CONSTRAINT UQ_PE_PE_NAME_ATTRIBUTE_APP_ID UNIQUE (OBJECT_ID, ATTRIBUTE, PROTECTION_ELEMENT_NAME, APPLICATION_ID)
;
...
values ("csmupt31","UPT Super Admin Application",0,1,sysdate());

insert into user (LOGIN_NAME,FIRST_NAME,LAST_NAME,PASSWORD,UPDATE_DATE)
values ("superadmin","super_admin_first_name","super_admin_last_name","changeme",sysdate());

insert into csm_user (LOGIN_NAME,FIRST_NAME,LAST_NAME,PASSWORD, UPTDATE_DATE)
...
values("csmupt31","UPT Super Admin Application","csmupt31",1,sysdate());
