...
DROP TABLE IF EXISTS PROTECTION_ELEMENT_TYPE
;
...
CREATE TABLE PROTECTION_ELEMENT_TYPE ( 
	PROTECTION_ELEMENT_TYPE_ID NUMERIC(10) NOT NULL,
	PROTECTION_ELEMENT_TYPE_NAME VARCHAR(100) NOT NULL,
	UPDATE_DATE DATE NOT NULL,
	PRIMARY KEY(PROTECTION_ELEMENT_TYPE_ID)
) TYPE=InnoDB
;
...
ADD CONSTRAINT UQ_PROTECTION_ELEMENT_PROTECTION_ELEMENT_NAME UNIQUE (APPLICATION_ID, PROTECTION_ELEMENT_NAME)
;
CREATE INDEX idx_APPLICATION_ID ON PROTECTION_ELEMENT(APPLICATION_ID)
;
CREATE INDEX idx_PROTECTION_ELEMENT_TYPE_ID ON PROTECTION_ELEMENT(PROTECTION_ELEMENT_TYPE_ID)
;
...
ADD CONSTRAINT UQ_USER_GROUP_USER_ID UNIQUE (GROUP_ID, USER_ID)
;
...
ALTER TABLE GROUPS ADD CONSTRAINT FK_APPLICATION 
...
ALTER TABLE PROTECTION_ELEMENT ADD CONSTRAINT FK_PROTECTION_ELEMENT_TYPE 
FOREIGN KEY (PROTECTION_ELEMENT_TYPE_ID) REFERENCES PROTECTION_ELEMENT_TYPE (PROTECTION_ELEMENT_TYPE_ID)
;
...
ALTER TABLE PROTECTION_GROUP_PROTECTION_ELEMENT ADD CONSTRAINT FK_PROTECTION_ELEMENT 
FOREIGN KEY (PROTECTION_ELEMENT_ID) REFERENCES PROTECTION_ELEMENT (PROTECTION_ELEMENT_ID)
;

ALTER TABLE PROTECTION_GROUP_PROTECTION_ELEMENT ADD CONSTRAINT FK_PGPE_PROTECTION_GROUP 
FOREIGN KEY (PROTECTION_GROUP_ID) REFERENCES PROTECTION_GROUP (PROTECTION_GROUP_ID)
;

ALTER TABLE ROLE ADD CONSTRAINT FK_ROLE_APPLICATION 
FOREIGN KEY (APPLICATION_ID) REFERENCES APPLICATION (APPLICATION_ID)
;
...
ALTER TABLE ROLE_PRIVILEGE ADD CONSTRAINT FK_PRIVILEGE 
FOREIGN KEY (PRIVILEGE_ID) REFERENCES PRIVILEGE (PRIVILEGE_ID)
;

ALTER TABLE USER_GROUP ADD CONSTRAINT FK_USER 
FOREIGN KEY (USER_ID) REFERENCES USER (USER_ID)
;

ALTER TABLE USER_GROUP ADD CONSTRAINT FK_GROUP 
FOREIGN KEY (GROUP_ID) REFERENCES GROUPS (GROUP_ID)
;

ALTER TABLE USER_GROUP_ROLE_PROTECTION_GROUP ADD CONSTRAINT FK_UGR_PROTECTION_GROUP 
FOREIGN KEY (PROTECTION_GROUP_ID) REFERENCES PROTECTION_GROUP (PROTECTION_GROUP_ID)
;

ALTER TABLE USER_GROUP_ROLE_PROTECTION_GROUP ADD CONSTRAINT FK_UGRPG_USER 
FOREIGN KEY (USER_ID) REFERENCES USER (USER_ID)
;

ALTER TABLE USER_GROUP_ROLE_PROTECTION_GROUP ADD CONSTRAINT FK__UGRPG_ROLE 
FOREIGN KEY (ROLE_ID) REFERENCES ROLE (ROLE_ID)
;

ALTER TABLE USER_GROUP_ROLE_PROTECTION_GROUP ADD CONSTRAINT FK_UGRPG_GROUP 
FOREIGN KEY (GROUP_ID) REFERENCES GROUPS (GROUP_ID)
;

ALTER TABLE USER_PROTECTION_ELEMENT ADD CONSTRAINT FK_UPE_PROTECTION_ELEMENT 
FOREIGN KEY (PROTECTION_ELEMENT_ID) REFERENCES PROTECTION_ELEMENT (PROTECTION_ELEMENT_ID)
;

ALTER TABLE USER_PROTECTION_ELEMENT ADD CONSTRAINT FK_UPE_USER 
FOREIGN KEY (USER_ID) REFERENCES USER (USER_ID)
;
