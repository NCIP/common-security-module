...
ALTER TABLE USER_GROUP_ROLE_PROTECTION_GROUP ADD CONSTRAINT FK_PROTECTION_GROUP_UGRPG 
FOREIGN KEY (PROTECTION_GROUP_ID) REFERENCES PROTECTION_GROUP (PROTECTION_GROUP_ID)
;

ALTER TABLE USER_GROUP_ROLE_PROTECTION_GROUP ADD CONSTRAINT FK_ROLE_UGRPG 
FOREIGN KEY (ROLE_ID) REFERENCES ROLE (ROLE_ID)
;
