 ...
 * @author parmarv
 */
public class CGMMCSMException extends CGMMException
{
	/**
	 * 
	 */
	 ...
	 */
	public CGMMCSMException(String message) {
		super(message);
	 ...
	 */
	public CGMMCSMException(String message, Throwable cause) {
		super(message, cause);
	 ...
	 * @param cause the actual exception which occured and caused this exception
	 */
	public CGMMCSMException(Throwable cause) {
		super(cause);
