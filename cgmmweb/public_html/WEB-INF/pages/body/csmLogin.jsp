...
<tr>
	<td valign="top" class="contentPage">
		...
		<logic:present name="<%=CGMMConstants.LOGIN_WORKFLOW%>">
			<%
						if (CGMMConstants.GRID_WORKFLOW.equalsIgnoreCase((String) request
						.getSession().getAttribute(CGMMConstants.LOGIN_WORKFLOW))) {
			%>
			...
			<tr>
				...
				<td class="formMessage" colspan="3">
					Dont have a local (CSM) Account?. Click button to proceed. 
