...
CREATE DATABASE cgmm_container_managed_security;

USE cgmm_container_managed_security;
...
insert into csm_user (LOGIN_NAME,FIRST_NAME,LAST_NAME,PASSWORD,UPDATE_DATE)
values ("/O=caBIG/OU=caGrid/OU=Training/OU=Dorian/CN=cgmmtmpuser2","CGMM User","Temp","zJPWCwDeSgG8j2uyHEABIQ==",sysdate());
...
VALUES ("sampleHostApplicationName","Application Description",0,0,
	"jdbc:mysql://localhost:3306/cgmm_container_managed_security",
	"root",
	"H/2qIBdj9TQ=",
...
insert into csm_group(GROUP_NAME,UPDATE_DATE,APPLICATION_ID) values ("WebAppUser",sysdate(),2);
