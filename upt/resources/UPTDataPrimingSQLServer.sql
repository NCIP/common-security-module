...
values ("<<upt_context_name>>","UPT Super Admin Application",0,0,GETDATE());

insert into csm_user (LOGIN_NAME,FIRST_NAME,LAST_NAME,UPDATE_DATE)
values ("<<super_admin_login_id>>","<<super_admin_first_name >> ","<<super_admin_last_name >> ",GETDATE());
...
values("<<upt_context_name>>","UPT Super Admin Application","<<upt_context_name>>",1,GETDATE());
