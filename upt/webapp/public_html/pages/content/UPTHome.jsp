...
<table summary="" cellpadding="0" cellspacing="0" border="0" class="contentPage" width="100%" height="100%">
            ...
            <p>Welcome to the User Provisioning Tool. With this tool you may configure 
              your application's authorization data in the common security module 
              database. Modify, delete, or create Groups, Privileges, Protection 
              Elements, Protection Groups, Roles, or Users. Begin by selecting 
              a link below:</p>
														</td>
													</tr>
													<tr>
          ...
          <td>&nbsp; </td>
            ...
            <p><a href="#">Protection Elements</a><br />
              data set that has a controlled access as per the roles and privileges. 
              A protected element can be any object also. Basically it is a conceptual 
              entity that an application will associate with any piece of data 
              that it wants to protect.</p>
            ...
            <p><a href="#">Roles</a><br />
              ...
              group. A role is assigned to user to grant them privileges on particular 
              protection group.</p>
            <p><a href="#">Users</a><br />
