			...
			<tr>
				...
				<table summary="" cellpadding="0" cellspacing="0" border="0" height="100%">
					...
					<table summary="" cellpadding="0" cellspacing="0" border="0" width="100%" class="sidebarSection">
						...
						<tr>
							<td class="sidebarContent"><a href="javascript: setAndSubmit('loadAdd')">Create a New Role</a><br>
							Click to add a new role.</td>
						</tr>
						<tr>
							<td class="sidebarContent"><a href="javascript: setAndSubmit('loadSearch')">Select an Existing Role</a><br>
