...
<html:form styleId="tableHomeForm" action = "/ProtectionElementDBOperation">
			...
			<tr>
				...
				<table summary="" cellpadding="0" cellspacing="0" border="0" height="100%">
					...
					<table summary="" cellpadding="0" cellspacing="0" border="0" width="100%" class="sidebarSection">
						...
						<tr>
							<td class="sidebarContent"><a href="javascript: setAndSubmit('loadAdd')">Create a New Protection Element</a><br>
							Click to add a new protection element.</td>
						</tr>
						<tr>
							<td class="sidebarContent"><a href="javascript: setAndSubmit('loadSearch')">Select an Existing Protection Element</a><br>
							Enter search criteria to find the protection element you wish to operate on.</td>
						</tr>
					</table>
					</td>
					</tr>
