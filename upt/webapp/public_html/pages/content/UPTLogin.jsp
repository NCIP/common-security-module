                        ...
                        <table summary="" cellpadding="0" cellspacing="0" border="0" height="100%">
                          <tr>
                            <td width="70%">
                              ...
                              <table summary="" cellpadding="0" cellspacing="0" border="0" height="100%">
                                <tr>
                                  <td class="welcomeTitle" height="20">WELCOME 
                                    TO THE USER PROVISIONING TOOL</td>
                                </tr>
                                <tr>
                                  <td class="welcomeContent" valign="top"> Welcome 
                                    to the User Provisioning Tool. Here you may 
                                    configure your application's authorization 
                                    data in the common security module database. 
                                    Modify, delete, or create Groups, Privileges, 
                                    Protection Elements, Protection Groups, Roles, 
                                    or Users. Begin by loggin in.</td>
                                </tr>
                              </table>
                              <!-- welcome ends -->
