...
<html:form styleId="detailsForm" action="<%="/"+session.getAttribute(DisplayConstants.CURRENT_TABLE_ID)+"DBOperation"%>">
			...
			<table cellpadding="0" cellspacing="0" border="0" class="contentBegins">
				<tr>
					...
					<table summary="" cellpadding="3" cellspacing="0" border="0" align="center">
						...
						<tr>
							<td class="formTitle" height="20" colspan="3"><%=TABLE_NAME_UPPER%> DETAIL SCREEN</td>
						</tr>
						<logic:present name="<%=DisplayConstants.CURRENT_FORM%>">
							...
							<logic:notEqual name="<%=DisplayConstants.CURRENT_ACTION%>" value="<%=DisplayConstants.SEARCH%>">
							<logic:notEqual name="<%=DisplayConstants.CURRENT_ACTION%>" value="<%=DisplayConstants.ADD%>">
