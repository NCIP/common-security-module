...
ALTER TABLE CSM_MAPPING ADD CONSTRAINT PK_MAPPING_ID 
PRIMARY KEY (MAPPING_ID) 
;

ALTER TABLE CSM_MAPPING ADD CONSTRAINT UQ_MP_OBJ_NAM_ATTRI_NAM_APP_ID
...
ALTER TABLE CSM_MAPPING ADD CONSTRAINT FK_CSM_APP_CSM_MAPPING 
